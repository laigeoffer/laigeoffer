---
title: 技术架构选型
date: 2024-07-08 14:14:17
permalink: /pages/ad9e01/
categories:
  - PmHub
  - 项目介绍
tags:
...
接下来我们需要将上面的方法论以及业务拆分后的微服务串连起俩，看一下 PmHub 整体是如何耍起来的。

### 整体交互设计
对于 PmHub 的核心，在于项目管理以及流程管控，用户添加项目，可以设置任务并制定任务执行人，执行人拿到任务后进行任务状态变更如交付物上传，其他同类型人可以对此发表评论，完成任务后可以发起任务完成审批，等待任务发起人（通常是项目经理）审批通过后，该任务就完成了。
...
登录基于传统的用户名和密码实现，下面是具体的交互流程图，大家可以对着代码看看，理解会更深！

![PmHub登录交互方案](https://cdn.tobebetterjavaer.com/stutymore/PmHub登录交互方案.svg)


### 消息通知方案
我们抽离了消息通知公共组件到 pmhub-base-notice，支持发送消息到企业微信等第三方平台，下面是一个具体的交互流程，当然这部分的细节实现可以参看：
[✅PmHub整合Rocketmq实现审批流消息推送（👍必看）](https://www.yuque.com/canghe-u0ocv/laigeoffer-pmhub/kwt70t4h33ncix87)
