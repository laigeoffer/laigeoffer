---
title: PmHub本地搭建Redis
shortTitle: PmHub本地搭建Redis
...
Redis 的搭建，比较简单，无论是哪种系统都不难。
①、如果你是 macOS 用户，可以直接在终端输入redis-server启动 Redis。

![本期启动redis](https://cdn.tobebetterjavaer.com/stutymore/efe1dae8-aa19-4d9f-920d-380ce58dc4ca.png)
